...
ENT.Radius = 60	-- Made smoke grenades about 3 times stronger than TTT1.
ENT.ThicknessMultiplier = 1.4	-- How thick is the smoke.
...
if CLIENT then
	...
	function ENT:CreateSmoke(center)
		...
		for i = 1, math.ceil(self.Radius * self.ThicknessMultiplier) do
			local prpos = VectorRand() * self.Radius
			prpos.z = prpos.z + 32
