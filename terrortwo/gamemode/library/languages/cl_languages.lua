...
-- Returns:		String , Phrase in the clients languages. If that phrase isn't valid in the clients language then it returns it in english. If that's not valid, returns "INVALID-PHRASE".
